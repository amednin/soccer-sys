...
use SoccerSys\FrontendBundle\Entity\Team;
use SoccerSys\FrontendBundle\Form\TeamType;
...
class TeamController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SoccerSysFrontendBundle:Team')->findAll();

        return $this->render('SoccerSysFrontendBundle:Team:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('SoccerSysFrontendBundle:Team:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SoccerSysFrontendBundle:Team')->find($id);
        ...
        return $this->render('SoccerSysFrontendBundle:Team:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('SoccerSysFrontendBundle:Team:edit.html.twig', array(
            'entity'      => $entity,
